...
temperature = np.array([15, 20, 25, 18, 22, 30, 12, 14, 16, 17, 24])
humidity = np.array([60, 70, 65, 75, 80, 50, 55, 63, 76, 56, 79])
growth = np.array([5.2, 6.1, 7.0, 5.5, 6.5, 8.0, 4.8, 8.2, 9.2, 7.4, 6.3])
